...
func (mg *Idl) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
		CurrentValue: reference.FromPtrValue(mg.Spec.ForProvider.TablegroupID),
		Extract:      reference.ExternalName(),
		Reference:    mg.Spec.ForProvider.TablegroupIDRef,
		Selector:     mg.Spec.ForProvider.TablegroupIDSelector,
		To: reference.To{
			List:    &TableGroupList{},
			Managed: &TableGroup{},
		},
	...
	if err != nil {
		return errors.Wrap(err, "mg.Spec.ForProvider.TablegroupID")
	}
