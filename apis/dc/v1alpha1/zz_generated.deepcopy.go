...
func (in *GatewayInitParameters) DeepCopyInto(out *GatewayInitParameters) {
	*out = *in
	...
	if in.GatewayAsn != nil {
		in, out := &in.GatewayAsn, &out.GatewayAsn
		*out = new(float64)
		**out = **in
	}
	...
	if in.HaZoneGroupID != nil {
		in, out := &in.HaZoneGroupID, &out.HaZoneGroupID
		*out = new(string)
		**out = **in
	}
	if in.ModeType != nil {
		in, out := &in.ModeType, &out.ModeType
		*out = new(string)
		**out = **in
	}
	if in.Name != nil {
