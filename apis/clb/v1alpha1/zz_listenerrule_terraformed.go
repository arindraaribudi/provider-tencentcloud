...
// GetInitParameters of this ListenerRule
func (tr *ListenerRule) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
func (tr *ListenerRule) LateInitialize(attrs []byte) (bool, error) {
	...
	opts = append(opts, resource.WithNameFilter("Domain"))
	opts = append(opts, resource.WithNameFilter("Domains"))
