...
func (in *CCNInitParameters) DeepCopyInto(out *CCNInitParameters) {
	*out = *in
	...
	if in.RouteEcmpFlag != nil {
		in, out := &in.RouteEcmpFlag, &out.RouteEcmpFlag
		*out = new(bool)
		**out = **in
	}
	if in.RouteOverlapFlag != nil {
		in, out := &in.RouteOverlapFlag, &out.RouteOverlapFlag
		*out = new(bool)
		**out = **in
	}
	if in.Tags != nil {
