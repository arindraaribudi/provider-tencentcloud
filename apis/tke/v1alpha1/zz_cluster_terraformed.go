...
func (tr *Cluster) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"exist_instance[*].instances_para[*].password": "spec.forProvider.existInstance[*].instancesPara[*].passwordSecretRef", "kube_config": "status.atProvider.kubeConfig", "kube_config_intranet": "status.atProvider.kubeConfigIntranet", "master_config[*].password": "spec.forProvider.masterConfig[*].passwordSecretRef", "worker_config[*].password": "spec.forProvider.workerConfig[*].passwordSecretRef"}
}
