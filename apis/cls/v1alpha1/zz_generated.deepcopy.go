...
func (in *ContentInitParameters) DeepCopyInto(out *ContentInitParameters) {
	*out = *in
	...
	if in.Parquet != nil {
		...
		*out = make([]ParquetInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ContentObservation) DeepCopyInto(out *ContentObservation) {
	*out = *in
	...
	if in.Parquet != nil {
		in, out := &in.Parquet, &out.Parquet
		*out = make([]ParquetObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ContentParameters) DeepCopyInto(out *ContentParameters) {
	*out = *in
	...
	if in.Parquet != nil {
		in, out := &in.Parquet, &out.Parquet
		*out = make([]ParquetParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ParquetInitParameters) DeepCopyInto(out *ParquetInitParameters) {
	*out = *in
	if in.ParquetKeyInfo != nil {
		in, out := &in.ParquetKeyInfo, &out.ParquetKeyInfo
		*out = make([]ParquetKeyInfoInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ParquetInitParameters.
func (in *ParquetInitParameters) DeepCopy() *ParquetInitParameters {
	if in == nil {
		return nil
	}
	out := new(ParquetInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ParquetKeyInfoInitParameters) DeepCopyInto(out *ParquetKeyInfoInitParameters) {
	*out = *in
	if in.KeyName != nil {
	...
	if in.KeyNonExistingField != nil {
		in, out := &in.KeyNonExistingField, &out.KeyNonExistingField
		*out = new(string)
		**out = **in
	}
	if in.KeyType != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ParquetKeyInfoInitParameters.
func (in *ParquetKeyInfoInitParameters) DeepCopy() *ParquetKeyInfoInitParameters {
	if in == nil {
		return nil
	}
	out := new(ParquetKeyInfoInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ParquetKeyInfoObservation) DeepCopyInto(out *ParquetKeyInfoObservation) {
	*out = *in
	if in.KeyName != nil {
		in, out := &in.KeyName, &out.KeyName
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ParquetKeyInfoObservation.
func (in *ParquetKeyInfoObservation) DeepCopy() *ParquetKeyInfoObservation {
	if in == nil {
		return nil
	}
	out := new(ParquetKeyInfoObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ParquetKeyInfoParameters) DeepCopyInto(out *ParquetKeyInfoParameters) {
	*out = *in
	if in.KeyName != nil {
		in, out := &in.KeyName, &out.KeyName
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ParquetKeyInfoParameters.
func (in *ParquetKeyInfoParameters) DeepCopy() *ParquetKeyInfoParameters {
	if in == nil {
		return nil
	}
	out := new(ParquetKeyInfoParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ParquetObservation) DeepCopyInto(out *ParquetObservation) {
	*out = *in
	if in.ParquetKeyInfo != nil {
		in, out := &in.ParquetKeyInfo, &out.ParquetKeyInfo
		*out = make([]ParquetKeyInfoObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ParquetObservation.
func (in *ParquetObservation) DeepCopy() *ParquetObservation {
	if in == nil {
		return nil
	}
	out := new(ParquetObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ParquetParameters) DeepCopyInto(out *ParquetParameters) {
	*out = *in
	if in.ParquetKeyInfo != nil {
		in, out := &in.ParquetKeyInfo, &out.ParquetKeyInfo
		*out = make([]ParquetKeyInfoParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ParquetParameters.
func (in *ParquetParameters) DeepCopy() *ParquetParameters {
	if in == nil {
		return nil
	}
	out := new(ParquetParameters)
	in.DeepCopyInto(out)
	return out
}
